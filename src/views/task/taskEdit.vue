            ...
            <el-row>
                <el-col :span="20">
                    ...
                    <el-form-item label="时限" prop="time">
                        <el-date-picker style="width:auto" v-model="form.time" align="right" type="date" :editable="false" placeholder="选择时限" format="yyyy年MM月dd日">
                        </el-date-picker>
                    </el-form-item>
                    <el-form-item label="完成情况" prop="complete">
                        <el-switch v-model="form.complete" active-color="#13ce66" inactive-color="#ff4949" active-text="完成" inactive-text="未完成">
                        </el-switch>
                    </el-form-item>
                    <el-form-item label="任务内容" prop="content">
                        <el-input resize="none" type="textarea" :rows="4" placeholder="请输入任务内容" v-model="form.content">
                        </el-input>
                    </el-form-item>
                </el-col>
            </el-row>
    ...
    data () {
        return {
            ...
            rules: {
                ...
                time: [{ required: true, message: '请输入正确的任务时限', trigger: 'blur' }],
                content: [
